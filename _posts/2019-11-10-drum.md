...
<div class="container-audio">
    <div>
        ...
        <audio
            class="video-js vjs-default-skin"
            controls loop preload="metadata"
            poster="/static/img/drum/rudiments/01-single-stroke-four-poster.png"
            data-setup='{}' >
          <source src="/static/audio/drum/rudiments/01-single-stroke-four-bronze.mp3" type='audio/mp3'/>
        </audio>
    </div>
    <div>
        <h4>Solver</h4>
        <audio
            ...
            poster="/static/img/drum/rudiments/01-single-stroke-four-poster.png"
            data-setup='{}' >
          <source src="/static/audio/drum/rudiments/01-single-stroke-four-silver.mp3" type='audio/mp3'/>
        </audio>
    </div>
</div>
...
<div class="container-audio">
    <div>
        ...
        <audio
            class="video-js vjs-default-skin"
            controls loop preload="metadata"
            poster="/static/img/drum/rudiments/01-single-stroke-four-exercise.png"
            data-setup='{}' >
          <source src="/static/audio/drum/rudiments/01-single-stroke-four-bronzeapp.mp3" type='audio/mp3'/>
        </audio>
    </div>
    <div>
        <h4>Solver</h4>
        <audio
            ...
            poster="/static/img/drum/rudiments/01-single-stroke-four-exercise.png"
            data-setup='{}' >
          <source src="/static/audio/drum/rudiments/01-single-stroke-four-silverapp.mp3" type='audio/mp3'/>
        </audio>
    </div>
</div>
